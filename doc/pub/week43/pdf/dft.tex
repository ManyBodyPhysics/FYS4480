...
\frame[containsverbatim]
{
  \frametitle{Density Functional Theory, definitions, onebody density}
\begin{small}
{\scriptsize
...
\frame[containsverbatim]
{
  \frametitle{Density Functional Theory, definitions, twobody density}
\begin{small}
{\scriptsize
...
\frame
{ 
  \frametitle{Hartree-Fock equations and density matrix}
  \begin{small}
    {\scriptsize
...
\begin{eqnarray}
\lefteqn{ \hat{H} = -\frac{\hbar^{2}}{2m}\int d^{3}r\hat{\Psi}^{\dagger}(\mathbf{r})\nabla^{2}\hat{\Psi}(\mathbf{r})+\int d^{3}r\hat{\Psi}^{\dagger}(\mathbf{r})v_{\mathrm{ext}}(\mathbf{r})\hat{\Psi}(\mathbf{r}) } \nonumber\\
& & {}+\frac{1}{2}\int d^{3}r\int d^{3}r'\hat{\Psi}^{\dagger}(\mathbf{r})\hat{\Psi}^{\dagger}(\mathbf{r'}) v(\mathbf{r},\mathbf{r'})\hat{\Psi}(\mathbf{r'})\hat{\Psi}(\mathbf{r}),\nonumber
\end{eqnarray}
}
%\end{small}
}
...
{ 
  ...
  \begin{small}
    {\scriptsize
      \begin{align}
        E_{c}[\rho]&=E_{\mathrm{XC}}[\rho]-E_{x}[\rho] \nonumber \\
...
\begin{equation}
  E_{v_{0}}[\rho]:=\bra{\Psi[\rho]}\hat{T}+\hat{W}+\hat{V_{0}}\ket{\Psi[\rho]} \nonumber
\end{equation}
$\hat{V_{0}} =$ external potential, $\rho_{0}(\mathbf{r}) =$ corresponding GS density, $E_{0} =$ GS energy
%\pause
...
{ 
  ...
  \begin{small}
    {\scriptsize
      ...
      \end{equation}
      s. t. $\delta E_{s}[\rho]=0$ gives GS density $n_{s}(\mathbf{r})$ corresp. to $\hat{H}_{s}$
  ...
  \begin{small}
    {\scriptsize
      ...
      \begin{theorem}
        ...
        \begin{equation}
          \exists \;\; \text{ a }\;\; v_{s}(\mathbf{r}) \;\; \text{s. t.} \;\; n_{s}(\mathbf{r})=\rho(\mathbf{r})  \nonumber
        \end{equation}
      \end{theorem}
      %\pause
...
{ 
  ...
  \begin{small}
    {\scriptsize
      ...
      \begin{equation}
        \rho(\mathbf{r})=n_{s}(\mathbf{r})=\sum_{i=1}^{N}\left\vert \phi_{i}(\mathbf{r})\right\vert^{2}, \nonumber
      \end{equation}
  ...
  \begin{small}
    {\scriptsize
      ...
      \begin{align}
        ...
        &=\left(T_{s}[\rho]+\frac{1}{2}\iint d^{3}r d^{3}r' \rho(\mathbf{r})w(\mathbf{r},\mathbf{r}')\rho(\mathbf{r}')+E_{\mathrm{XC}}[\rho]\right) + \int d^{3}r v_{0}(\mathbf{r})\rho(\mathbf{r}) \nonumber 
      \end{align}
      Here \alert{exchange-correlation functional} defined: 
      \begin{equation}
        E_{\mathrm{XC}}[\rho]=F_{L}[\rho]-\frac{1}{2}\iint d^{3}r d^{3}r' \rho(\mathbf{r})w(\mathbf{r},\mathbf{r}')\rho(\mathbf{r}')-T_{s}[\rho] \nonumber
      \end{equation}
    }
  \end{small}
}
...
{ 
  ...
  \begin{small}
    {\scriptsize
      ...
      \end{equation}
      \vspace{5mm}
      \alert{Explicit form} of $F_{L}[\rho]$ as functional of $n$ \alert{unknown}
      \begin{itemize}
        \item $E_{\mathrm{XC}}[\rho]$ unknown functional, must be approximated \\
  ...
  \begin{small}
    {\scriptsize
      ...
      \begin{definition}
        ...
        \begin{equation}
          \frac{\delta F}{\delta n}[\varphi ]=\lim_{\varepsilon \rightarrow 0}\frac{F[n+\varepsilon \varphi ]-F[\rho]}{\varepsilon } \nonumber
        \end{equation}
        Another useful definition of $\delta F[\rho]$:
        \begin{equation}
          \left< \delta F[\rho],\varphi \right>=\frac{d}{d\varepsilon }F[n+\varepsilon \phi ]\Bigg\vert_{\varepsilon =0}, \nonumber
        \end{equation}
        where
        \begin{equation}
...
{ 
  ...
  \begin{small}
    {\scriptsize
      ...
      \vspace{2mm}
      \structure{Taylor expansion} of $E_{\mathrm{XC}}[\rho]$ \\
      around homogeneous electron gas (HEG) \\
      density $n_{0}$ $\quad $ ($(n-n_{0})/n_{0}\ll 1$):
      
     \begin{equation}
       E_{\mathrm{XC}}[\rho]=E_{\mathrm{XC}}[n_{0}]+\sum_{m=1}^{\infty }\frac{1}{m!}\int d^{3m}r \frac{\delta^{m}E_{\mathrm{XC}}}{\delta \rho(\mathbf{r}_{1})\dots \delta \rho(\mathbf{r}_{m})}\Bigg\vert_{n=n_{0}}\delta \rho(\mathbf{r}_{1})\dots \delta \rho(\mathbf{r}_{m}) \nonumber
     \end{equation}
    }
  \end{small}
}
...
{ 
  ...
  \begin{small}
    {\scriptsize
      ...
      \begin{align}
        E_{\mathrm{XC}}[\rho]&=E_{\mathrm{XC}}^{LDA}[\rho]+\int d^{3}r g_{1}(\rho(\mathbf{r}))(\nabla \rho(\mathbf{r}))^{2} \nonumber \\
        &+\int d^{3}r g_{2}(\rho(\mathbf{r}))(\nabla^{2}\rho(\mathbf{r}))^{2}+\dots , \nonumber
      \end{align}
  ...
  \begin{small}
    {\scriptsize
      ...
      \begin{center}
        ...
        may give a considerably worse $E_{\mathrm{XC}}[\rho]$ than $E_{\mathrm{XC}}^{LDA}[\rho]$
      \end{center}
...
{ 
  ...
  \begin{small}
    {\scriptsize
      %\begin{center}
      $E_{\mathrm{XC}}^{LDA}[\rho]$ $\quad $ provides rather realistic results $\quad $ for atoms, molecules, and solids
  ...
  \begin{small}
    {\scriptsize
      ...
      \begin{center}
        \begin{tabular}{c c c}
          \hline
          $E_{\mathrm{XC}}[\rho]$ & Equilibrium & Cohesive \\
  ...
  \begin{small}
    {\scriptsize
      ...
      \begin{align} \label{eq:hkVar}
        ...
        &=\delta T_{s}+\int d^{3}r\delta \rho(\mathbf{r})\left[v_{0}(\mathbf{r})+\int w(\mathbf{r},\mathbf{r}')d^{3}r'+v_{\mathrm{exc}}([n_{0}];\mathbf{r})\right],   
      \end{align}
      where exchange-coorelation potential 
      \begin{equation}
        v_{\mathrm{exc}}([n_{0}];\mathbf{r})=\frac{\delta E_{\mathrm{exc}}[\rho]}{\delta \rho(\mathbf{r})}\Bigg\vert_{n_{0}}, \nonumber
      \end{equation}
...
{ 
  ...
  \begin{small}
    {\scriptsize
      $n_{0}(\mathbf{r})+\delta \rho(\mathbf{r})$ non-interacting $v$-representable $\quad \Longrightarrow \quad $ unique representation $\phi_{i,0}(\mathbf{r})+\delta \phi_{i}(\mathbf{r})$ 
      \vspace{10mm}
...
{ 
  ...
  \begin{small}
    {\scriptsize
      ...
      \vspace{2mm}
      \structure{Taylor expansion} of $E_{\mathrm{exc}}[\rho]$ \\
      around homogeneous electron gas (HEG) \\
      density $n_{0}$ $\quad $ ($(n-n_{0})/n_{0}\ll 1$):
      
     \begin{equation}
       E_{\mathrm{exc}}[\rho]=E_{\mathrm{exc}}[n_{0}]+\sum_{m=1}^{\infty }\frac{1}{m!}\int d^{3m}r \frac{\delta^{m}E_{\mathrm{exc}}}{\delta \rho(\mathbf{r}_{1})\dots \delta \rho(\mathbf{r}_{m})}\Bigg\vert_{n=n_{0}}\delta \rho(\mathbf{r}_{1})\dots \delta \rho(\mathbf{r}_{m}) \nonumber
     \end{equation}
    }
  \end{small}
}
...
{ 
  ...
  \begin{small}
    {\scriptsize
      ...
      Expansion can be written
      \begin{align}
        E_{\mathrm{exc}}[\rho]&=E_{\mathrm{exc}}^{LDA}[\rho]+\int d^{3}r g_{1}(\rho(\mathbf{r}))(\nabla \rho(\mathbf{r}))^{2} \nonumber \\
        &+\int d^{3}r g_{2}(\rho(\mathbf{r}))(\nabla^{2}\rho(\mathbf{r}))^{2}+\dots , \nonumber
      \end{align}
      $g_{i}(n)$ uniquely determined by the density response functions of a HEG
    }
  ...
  \begin{small}
    {\scriptsize
      ...
      \begin{center}
        Numerical tests show: \\
        Inclusion of second-order gradient term \\
        may give a considerably worse $E_{\mathrm{exc}}[\rho]$ than $E_{\mathrm{exc}}^{LDA}[\rho]$
      \end{center}
...
{ 
  ...
  \begin{small}
    {\scriptsize
      %\begin{center}
      $E_{\mathrm{exc}}^{LDA}[\rho]$ $\quad $ provides rather realistic results $\quad $ for atoms, molecules, and solids
  ...
  \begin{small}
    {\scriptsize
      ...
      \begin{center}
        \begin{tabular}{c c c}
          \hline
          $E_{\mathrm{exc}}[\rho]$ & Equilibrium & Cohesive \\
                    & lattice constant & energy \\
          \hline
           LDA & \structure{\textbf{7.68}} & \textbf{4.12} \\
           relativistic LDA & 7.68 & 4.09 \\
