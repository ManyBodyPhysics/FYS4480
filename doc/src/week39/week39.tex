...
\begin{frame}[plain,fragile]
\frametitle{Week 39, September 23-27, 2024}
...
\begin{frame}[plain,fragile]
\frametitle{One-particle-one-hole state}
...
\begin{frame}[plain,fragile]
\frametitle{Intermediate normalization}
...
\begin{frame}[plain,fragile]
\frametitle{Compact expression of correlated part}
...
\begin{frame}[plain,fragile]
\frametitle{FCI and the exponential growth}
...
\begin{frame}[plain,fragile]
\frametitle{A non-practical way of solving the eigenvalue problem}
...
\begin{frame}[plain,fragile]
\frametitle{Using the Condon-Slater rule}
...
\begin{frame}[plain,fragile]
\frametitle{Rewriting the FCI equation}
...
\begin{frame}[plain,fragile]
\frametitle{Rewriting the FCI equation, does not stop here}
...
\begin{frame}[plain,fragile]
\frametitle{Rewriting the FCI equation, more to add}
...
\begin{frame}[plain,fragile]
\frametitle{Summarizing FCI and bringing in approximative methods}
...
\begin{frame}[plain,fragile]
\frametitle{Definition of the correlation energy}
...
\begin{frame}[plain,fragile]
\frametitle{Why Hartree-Fock theory}
