...
\end{equation}
the string of $(1-2\hat{n}_k)=(-1)^{\hat{n}_k}$ supplying exactly the sign
that the bit-counting algorithm of Section~\ref{sec:bitrep} computes.  On a
...
\subsection*{Exercise 7: numerical explorations}
\addcontentsline{toc}{subsection}{Exercise 7: numerical explorations}
