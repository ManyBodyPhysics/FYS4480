...
the spins sampled the variational energy is $20.2206(29)$, and with the
assignment frozen it is $20.2194(31)$.  The two agree, as promised, and now as
a measurement.
...
\midrule
plain & no  & $20.2662(457)$ & $18.592$ -- $21.678$\\
plain & yes & $20.2187(32)$  & $20.141$ -- $20.306$\\
cut   & no  & $20.2194(31)$  & $20.151$ -- $20.273$\\
cut   & yes & $20.2206(29)$  & $20.150$ -- $20.304$\\
\bottomrule
\end{tabular}
...
and largest walker-averaged energy over the run.  Either remedy alone suffices
and the two together are no better.  Computed by \texttt{manybodymc.py}.}
\label{tab:16-nodes}
\end{table}

The three treated rows agree; the untreated one does not, and its error bar
does not warn you.  The honest summary is that the spin sampling asked for in
this chapter turns out to be worth rather little \emph{once the drift is cut},
and a great deal if it is not.  Both are used from here on.
