...
sequence after a Jordan-Wigner transformation.  The two are not the same,
...
$\bracket{\Psi}{\hat{H}}{\Psi}$, which is where the Pauli decomposition of
Section~\ref{sec:pauli} and the Jordan-Wigner mapping of
Section~\ref{sec:qcgates} enter.  Nothing else changes: the ansatz, the
variational principle and the optimisation loop are the ones in this section.
