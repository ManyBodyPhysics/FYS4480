...
\]
where $P$ is an operator which allows for all possible permutations among the particles that are present. The sum over $p$ runs over all possible permutations.
